...
module.exports = {
  secure: {
    ssl: true,
    privateKey: './config/sslcerts/wildcard.key',
    certificate: './config/sslcerts/wildcard.crt',
    caBundle: './config/sslcerts/ca_bundle.crt'
  },
  port: process.env.PORT || 443,
  port_http: process.env.PORT_HTTP || 80,
  // Binding to 127.0.0.1 is safer in production.
  host: process.env.HOST || '139.59.24.122',
  // host: process.env.HOST || '0.0.0.0',
  domain: 'hops.b-om.in',
  db: {
    baseUri: process.env.MONGODB_URI || process.env.MONGOHQ_URL || process.env.MONGOLAB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost'),
