...
module.exports = function (app) {
  ...
  // Setting up new user password api
  app.route('/api/auth/new/:token').get(users.validateNewAdminPasswordToken);
  app.route('/api/auth/new/:token').post(users.newAdminPasswordAndTenantInitialization);

  // setting up seed db api
  app.route('/api/auth/seed').post(users.seedDB);
