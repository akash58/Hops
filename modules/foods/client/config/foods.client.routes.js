  ...
  function routeConfig($stateProvider) {
    $stateProvider
      ...
      .state('foods.component', {
        url: '/foodcomponentscreate',
        templateUrl: '/modules/foods/client/views/create-foodcomponents.client.view.html',
        controller: 'FoodComponents',
        controllerAs: 'vm',
        data: {
          pageTitle: 'Food Components'
        }
      });
  }
