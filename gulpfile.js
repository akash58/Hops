...
gulp.task('watch', function () {
  ...
  gulp.watch('bootstrap_variables.less', ['bootstrap:compileLess']).on('change', plugins.refresh.changed);
...
gulp.task('bootstrap:prepareLess', function() {
  return gulp.src('bootstrap_variables.less')
    .pipe(rename('variables.less'))
    .pipe(gulp.dest('public/lib/bootstrap/less'));
});

// @abhinav - needed as regular less will not pick up the new variables.less file
...
// Less task
gulp.task('less', ['bootstrap:compileLess'], function () {
